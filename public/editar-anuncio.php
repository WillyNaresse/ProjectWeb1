    ...
    <main>
        ...
        <section class="details-container">
            ...
            <div class="details-info">
                <h3 style="margin-bottom: 0.5rem;">Chevrolet Onix LT 1.0 Flex</h3>
                <div class="details-price">R$ 55.900,00</div>
                
                <ul class="features-list">
                    <li><strong>Marca:</strong> Chevrolet</li>
                    <li><strong>Ano:</strong> 2020/2020</li>
                    <li><strong>Cor:</strong> Branco</li>
                    <li><strong>Quilometragem:</strong> 45.000 km</li>
                    <li><strong>Estado:</strong> Usado</li>
                    <li><strong>Cidade:</strong> São Paulo, SP</li>
                    <li><strong>Status:</strong> <span style="color: var(--success-color); font-weight: bold;">Ativo</span></li>
                </ul>
                
                <h3>Descrição</h3>
                <p style="margin-bottom: 2rem; color: var(--text-muted);">
                    Veículo em excelente estado de conservação, único dono. Todas as revisões realizadas na concessionária. Possui manual e chave reserva. Pneus novos, documentação em dia. Pronto para transferir!
                </p>
